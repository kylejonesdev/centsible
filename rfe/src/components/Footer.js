...
export default function Footer() {
    return (
        <footer className="footer p-10 mt-24 bg-primary">            
            <div className="items-center grid-flow-col text-white">
                ...
                <p>Centsible: Bookkeeping doesn't have to be scary. <br />
                Created by <a href="https://www.kylejones.dev" className="link font-bold">Kyle Jones</a></p>
            </div> 
            <div className="md:place-self-center md:justify-self-end">
                <div className="grid grid-flow-col gap-x-4">
                    <a href="https://www.github.com/kylejonesdev" className="text-white"><FontAwesomeIcon icon={faGithub} size='2xl'/><span className="sr-only">Github</span></a>
                    <a href="https://www.linkedin.com/in/kylejonesdev" className="text-white"><FontAwesomeIcon icon={faLinkedin} size='2xl'/><span className="sr-only">LinkedIn</span></a> 
                    <a href="https://www.twitter.com/kylejonesdev" className="text-white"><FontAwesomeIcon icon={faTwitter} size='2xl'/><span className="sr-only">Twitter</span></a>
                </div>
            </div>
        </footer>
    );
