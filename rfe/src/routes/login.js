...
export default function Login() {
  ...
  return (
    <>    
      <Header navVisible={false} />
      <main className="container mx-auto max-w-md">
        <div className="main-card pb-12 my-8">
          <header className="py-8">
            <div className="flex justify-center items-center pt-8 pb-3">
              ...
              <h1 className="hidden sm:inline text-6xl text-accent font-bold pl-2">Centsible</h1>
              <h1 className="sm:hidden text-4xl text-accent font-bold pl-2">Centsible</h1>
            </div>
            <p className="text-primary font-semibold text-center mx-4">Bookkeeping doesn't have to be scary.</p>
          </header>
          <section className="mx-8">
            ...
            <% }) %> <% } %> */}
            <form className="grid grid-cols-2 gap-y-4" action="/login" method="POST">
              <div className="form-control col-span-2">
                <label htmlFor="exampleInputEmail1" className="label">
                  <span className="label-text">Email address</span>
                </label>
                <input type="email" className="input input-bordered" id="exampleInputEmail1" name="email"/>
              ...
              <div className="form-control col-span-2">
                ...
                <input type="password" className="input input-bordered" id="exampleInputPassword1" name="password"/>
                <small>Password for bob@bob.com: bobbobbob</small>
              </div>
              <div className="col-span-2 flex justify-center gap-4 mt-4">
                <button type="submit" className="btn btn-primary">Submit</button>
                <a href="/" className="btn btn-primary btn-outline">Cancel</a>
              </div>
            </form>
          </section>
        </div>
